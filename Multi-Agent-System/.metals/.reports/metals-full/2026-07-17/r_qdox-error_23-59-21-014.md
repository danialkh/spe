...
### com.thoughtworks.qdox.parser.ParseException: syntax error @[403,1]
    ...
    class RealBlockchainClient implements BlockchainAdapter {
        ...
        public boolean logFleetAnomaly(String anomalyType, int count) {
            ...
            try {
                ...
                insights.getOrDefault(agentName, new MLInsight("unknown", 0.5, "low"));
...
QDox parse error in file://<WORKSPACE>/env/FleetMASEnvironment.java