error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:_empty_/Structure#
file://<WORKSPACE>/env/FleetMASEnvironment.java
empty definition using pc, found symbol in pc: _empty_/Structure#
...
public class FleetMASEnvironment extends Environment {
    ...
    @Override
    public boolean executeAction(String agentName, Structu@@re action) {
