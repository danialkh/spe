error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:java/net/http/HttpRequest#Builder#POST().
file://<WORKSPACE>/env/FleetMASEnvironment.java
empty definition using pc, found symbol in pc: java/net/http/HttpRequest#Builder#POST().
        ...
        public boolean logFleetAnomaly(String anomalyType, int count) {
            ...
            try {
                ...
                HttpRequest req = HttpRequest.newBuilder()
                        ...
                        .POS@@T(BodyPublishers.ofString(payload))
                        .build();
