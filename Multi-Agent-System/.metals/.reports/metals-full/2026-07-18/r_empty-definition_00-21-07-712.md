error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:env/FleetMASEnvironment#BlockchainAdapter#history#
file://<WORKSPACE>/env/FleetMASEnvironment.java
empty definition using pc, found symbol in pc: env/FleetMASEnvironment#BlockchainAdapter#history#
found definition using semanticdb; symbol env/FleetMASEnvironment#BlockchainAdapter#readDigitalTwin().
...
public class FleetMASEnvironment extends Environment {
    ...
    private boolean handleReadDigitalTwin(String agentName, String vin) {
        ...
        String history = blockchainAdapter.h@@istory(vin);

        System.out.println("[BLOCKCHAIN-REAL] history for history" + agentName + " (VIN: " + vin + ")");
