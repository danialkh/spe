error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:_empty_/countStr#
file://<WORKSPACE>/env/FleetMASEnvironment.java
empty definition using pc, found symbol in pc: _empty_/countStr#
...
public class FleetMASEnvironment extends Environment {
    ...
    public boolean executeAction(String agentName, Structure action) {
        ...
        switch (functor) {
            ...
            case "logFleetAnomalyToBlockchainLopp":
                anomalyType = action.getTerm(0).toString();
cou@@ntStr    = action.getTerm(1).toString();
            ...
            case "sendMQTTMessage":
                ...
                return handleMQTT(topic, payload);
