error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:_empty_/action#
file://<WORKSPACE>/env/FleetMASEnvironment.java
empty definition using pc, found symbol in pc: _empty_/action#
...
public class FleetMASEnvironment extends Environment {
    ...
    private boolean handleReadDigitalTwin(String agentName, String vin) {
        ...
        self.action.getTerm(0) = vin;
        @@action.getTerm(1) = history;
