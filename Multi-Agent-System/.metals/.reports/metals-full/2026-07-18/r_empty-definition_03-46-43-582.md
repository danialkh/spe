error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:java/net/http/HttpClient#newHttpClient().
file://<WORKSPACE>/env/FleetMASEnvironment.java
empty definition using pc, found symbol in pc: java/net/http/HttpClient#newHttpClient().
...
public class FleetMASEnvironment extends Environment {
    ...
    private boolean handleMQTT(String topic, String payload) {
        try {
            ...
            HttpClient client = HttpClient.newHt@@tpClient();
