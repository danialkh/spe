error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:java/util/logging/Logger#info().
file://<WORKSPACE>/env/FleetMASEnvironment.java
empty definition using pc, found symbol in pc: java/util/logging/Logger#info().
...
public class FleetMASEnvironment extends Environment {
    ...
    public boolean executeAction(String agentName, Structure action) {
        ...
        logger.inf@@o("[ENV] Action from " + agentName + ": " + functor);
