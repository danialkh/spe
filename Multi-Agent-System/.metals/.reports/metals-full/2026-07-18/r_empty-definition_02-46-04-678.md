error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:env/FleetMASEnvironment#addPercept#
file://<WORKSPACE>/env/FleetMASEnvironment.java
empty definition using pc, found symbol in pc: env/FleetMASEnvironment#addPercept#
    ...
    public boolean executeAction(String agentName, Structure action) {
        ...
        switch (functor) {
            ...
            case "registerVehicle":
                ...
                addPerce@@pt("fleet_coordinator_agent",
