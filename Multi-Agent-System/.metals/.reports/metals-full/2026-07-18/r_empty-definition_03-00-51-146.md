error id: file://<WORKSPACE>/env/FleetMASEnvironment.java:java/lang/Object#
...
public class FleetMASEnvironment extends Environment {
    ...
    public class sendMQTTMessage extends DefaultInternalAction {
        @Override
        public @@Object execute(TransitionSystem ts, Term[] args) throws Exception {
            String topic = args[0].toString();
            String payload = args[1].toString();

            // 1. Put your MQTT client logic here (e.g., Paho MQTT)
            // System.out.println("MQTT Publish to " + topic + ": " + payload);
